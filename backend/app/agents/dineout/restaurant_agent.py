...
from app.agents.dineout.tools import (
    book_dineout_factory,
...
class RestaurantAgent:
    """Restaurant agent with capabilities to search for restaurants and provide recommendations."""
    ...
    def __init__(
        ...
        """
        Initialize the Restaurant agent with private and public database connections.
    ...
    def _create_agent(self):
        ...
        tools = [
            ...
            private_db_query_factory(
                self.model, 
                self.private_db, 
                RESTAURANT_AQL_GENERATION_PROMPT
            )
        ]
...
if __name__ == "__main__":
    ...
    agent = RestaurantAgent(
        model=LLMManager.get_openai_model(model_name="gpt-4o-mini"),
    ...
    agent.run_interactive(thread_id="1234567890")